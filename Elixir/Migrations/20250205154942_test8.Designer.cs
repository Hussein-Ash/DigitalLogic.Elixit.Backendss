...
namespace Elixir.Migrations
{
    ...
    [Migration("20250205154942_test8")]
    partial class test8
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Elixir.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("384275fe-b4e4-479c-853a-23266a035376"),
                            Active = true,
                            CreationDate = new DateTime(2025, 2, 5, 15, 49, 41, 475, DateTimeKind.Utc).AddTicks(172),
                            Deleted = false,
                            Followings = 0,
                            FullName = "Admin",
                            Password = "$2a$11$pqyLBV5hq4pZE6i9niVpL.yMLJkjMktZHVY.75Lhy5T7ZgnAKCnjG",
                        ...
                        new
                        {
                            Id = new Guid("0fbcbed8-caf5-4fd7-b0e5-a1a3b3dc4359"),
                            Active = true,
                            CreationDate = new DateTime(2025, 2, 5, 15, 49, 41, 620, DateTimeKind.Utc).AddTicks(4843),
                            Deleted = false,
                            Followings = 0,
                            FullName = "superadmin",
                            Imgs = new List<string>(),
                            Password = "$2a$11$GlZ7OQMS4jDOGkm0u9t8T.UycjRoGjS17fUwP01e8.chx4ZvX6Bv.",
                            PhoneNumber = new List<string> { "01234567891" },
                            Role = 3,
                            SavedProducts = 0,
                            UserName = "superadmin"
