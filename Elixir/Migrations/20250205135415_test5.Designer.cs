...
namespace Elixir.Migrations
{
    ...
    [Migration("20250205135415_test5")]
    partial class test5
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Elixir.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4f8ba28e-6097-4906-928f-4d4ffb48b377"),
                            Active = true,
                            CreationDate = new DateTime(2025, 2, 5, 13, 54, 15, 500, DateTimeKind.Utc).AddTicks(8759),
                            Deleted = false,
                            Followings = 0,
                            FullName = "Admin",
                            Password = "$2a$11$XdFacoQ6HPt2zkxq1EynzeYoqsJKgkEVj/yEYMPH8pqlfscxc0Ycy",
