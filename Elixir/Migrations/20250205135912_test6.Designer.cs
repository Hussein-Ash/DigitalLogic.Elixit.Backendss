...
namespace Elixir.Migrations
{
    ...
    [Migration("20250205135912_test6")]
    partial class test6
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Elixir.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("219e7de7-bb65-4f82-9721-4c07ed5e5f74"),
                            Active = true,
                            CreationDate = new DateTime(2025, 2, 5, 13, 59, 12, 464, DateTimeKind.Utc).AddTicks(7486),
                            Deleted = false,
                            Followings = 0,
                            FullName = "Admin",
                            Password = "$2a$11$65tgrBpnW8fiE0gujiELgudEeWMeiw6qK031A/VoBgFDa/NehckwK",
