...
namespace Elixir.Migrations
{
    ...
    [Migration("20250204202801_test4")]
    partial class test4
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Elixir.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("58db94b5-3613-45c5-82a9-0be2347a112b"),
                            Active = true,
                            CreationDate = new DateTime(2025, 2, 4, 20, 28, 0, 865, DateTimeKind.Utc).AddTicks(5611),
                            Deleted = false,
                            Followings = 0,
                            FullName = "Admin",
                            Password = "$2a$11$/kOiVgAvYSwrdLSSdVwt..jPd4Sinsjx59ZxNKXKKfkMqZNjeMwUG",
