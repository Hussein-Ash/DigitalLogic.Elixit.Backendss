...
namespace Elixir.Migrations
{
    ...
    [Migration("20250204184223_test2")]
    partial class test2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Elixir.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("eee1f743-b16d-43ca-adca-9726d5fa03bf"),
                            Active = false,
                            CreationDate = new DateTime(2025, 2, 4, 18, 42, 22, 763, DateTimeKind.Utc).AddTicks(8339),
                            Deleted = false,
                            Followings = 0,
                            FullName = "Admin",
                            Password = "12345678",
